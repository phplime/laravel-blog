    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                <img src="https://localhost/qmenu/uploads/thumb/16d0a734ad9d84b254066df50b4ab90f.jpg"
            ...
            <ul class="dropdown-menu">
                ...
                <li class="user-header">
                    ...
                    <p>
                        Admin <small>Member since - 28 June, 2020</small>
                        <!-- <small id="time"></small> -->
                    </p>
                </li>
                <div class="text-center">
                    <small>Last Login - 12 October, 2021</small>
                </div>
                <!-- Menu Body -->
                <!-- Menu Footer-->
                <li class="user-footer">
                   <a href="https://localhost/qmenu/admin/auth/" class="btn btn-default btn-flat float-left">Profile</a>
